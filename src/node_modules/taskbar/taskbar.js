...
async function taskbar (opts, protocol) {
  ...
  function action_bar_protocol (send) {
    ...
    function action_bar_forward_up (msg) { _.up(msg) }
  }

  function action_executor_protocol (send) {
    _.action_executor = send
    const action_handlers = {
      load_actions: action_executor_forward_action_bar,
      step_clicked: action_executor_forward_action_bar,
      show_submit_btn: action_executor_forward_action_bar,
      hide_submit_btn: action_executor_forward_action_bar
    }
    return on
    function on (msg) {
      const handler = action_handlers[msg.type] || action_executor_noop
      handler(msg)
      _.up(msg)
    }

    function action_executor_forward_action_bar (msg) { _.action_bar(msg) }
    function action_executor_noop () {}
  }
  ...
  function tabsbar_protocol (send) {
    ...
    return on
    function on (msg) {
      const handler = action_handlers[msg.type] || tabsbar_noop
      handler(msg)
      _.up(msg)
    }
