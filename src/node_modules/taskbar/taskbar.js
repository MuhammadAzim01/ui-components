...
async function taskbar (opts, invite) {
  ...
  function action_bar_protocol (msg) {
    ...
    function action_bar_forward_action_executor (msg) { _.action_executor.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
    function action_bar_forward_up (msg) { _.up && _.up.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
  }
  ...
  function action_executor_protocol (msg) {
    ...
    function action_executor__forward_action_bar (msg) { _.action_bar.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
    function action_executor__noop () {}

    function action_executor__auto_completed (msg) { _.action_bar.send('action_submitted', msg.data, msg.head ? { cause: msg.head } : {} ) }
  }
  ...
  function tabsbar_protocol (msg) {
    ...
    function tabsbar_docs_toggle (msg) {
      _.action_bar.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} )
      _.action_executor.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} )
    }
  ...
  function handle_update_steps_wizard_for_app (msg) { _.action_executor.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
  function handle_docs_toggle (msg) { _.action_bar.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
  function handle_load_actions (msg) { forward_to_action_bar(msg.type, msg.data, msg) }
  function handle_step_clicked (msg) { _.action_bar.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
  ...
  function handle_submit_btn_toggle (msg) { _.action_bar.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
  function onmessage_forward_action_bar (msg) { _.action_bar.send(msg.type, msg.data, msg.head ? { cause: msg.head } : {} ) }
  function forward_to_action_bar (type, data, msg) {
    _.action_bar.send(type, data, msg.head ? { cause: msg.head } : {} )
  }
}
