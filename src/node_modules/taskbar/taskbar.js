...
async function taskbar (opts, protocol) {
  ...
  function action_bar_protocol (send) {
    ...
    function action_bar__forward_action_executor (msg) {
      _.action_executor && _.action_executor(msg)
    }

    function action_bar__forward_up (msg) {
      _.up && _.up(msg)
    }
  }
  ...
  function action_executor_protocol (send) {
    ...
    function action_executor__forward_action_bar (msg) {
  ...
  function onmessage_forward_action_bar (msg) {
    _.action_bar && _.action_bar(msg)
  }
}
