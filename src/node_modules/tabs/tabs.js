...
async function component (opts, invite) {
  ...
  function add_default_tab ({ name, program, tile_id }) {
    ...
    name_el.onclick = () => {
      ...
      _.up && _.up('tab_name_clicked', { id: tab_id, name, program }, {})
    }
    ...
    close_btn.onclick = (e) => {
      ...
      el.remove()
      _.up && _.up('tab_close_clicked', { id: tab_id, name }, {})
    }
  ...
  function add_link_tab ({ tile_id, name, direction }) {
    ...
    name_el.onclick = () => {
      ...
      _.up && _.up('link_tab_clicked', { tile_id, link_tab_id }, {})
    }
    
    close_btn.onclick = (e) => {
      e.stopPropagation()
      console.error('tabs: link tab close clicked', link_tab_id)
      _.up && _.up('link_tab_close_clicked', { tile_id, link_tab_id }, {})
    }
