...
async function quick_actions (opts, invite) {
  ...
  function onsubmit () {
    _.up && _.up.send('action_submitted', null, {})
  }

  function onconfirm () {
    _.up && _.up.send('activate_steps_wizard', stored_selected_action, {})
  }
  function oninput (e) {
    const value = e.target.value
    if (enable_input_field_tooltips) update_input_tooltip(value)
    _.up && _.up.send('filter_actions', value, {})
  }
  ...
  function activate_input_field () {
    ...
    _.up && _.up.send('display_actions', { display: 'block', reason: 'browse' }, {})
  }
  ...
  function deactivate_input_field (data) {
    ...
    _.up && _.up.send('display_actions', { display: 'none', reason }, {})
  }
  ...
  function create_action_button (action) {
    ...
    function onclick () {
      _.up && _.up.send('update_quick_actions_input', action.name, {})
    }
  }
  ...
  function update_input_command (command) {
    ...
    _.up && _.up.send('display_actions', { display: 'none', reason: 'selected' }, {})
    _.up && _.up.send('activate_steps_wizard', stored_selected_action, {})
