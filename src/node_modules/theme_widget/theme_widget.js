...
async function theme_widget (opts, protocol) {
  ...
  function onmessage_from_root (msg) {
    ...
    function root_retry_send_program_container (msg) { _.send_program_container(msg) }
    function root_forward_taskbar (msg) { _.send_taskbar(msg) }
  }
  ...
  function program_container_protocol (send) {
    ...
    function program_container_forward_up (msg) { _.up(msg) }
    function program_container_forward_taskbar (msg) { _.send_taskbar(msg) }
  }
  ...
  function taskbar_protocol (send) {
    ...
    function taskbar_forward_up (msg) { _.up(msg) }
    function taskbar_forward_program_container (msg) { _.send_program_container(msg) }
