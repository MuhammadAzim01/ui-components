  ...
  function render_steps (steps, auto_focus_first) {
    ...
    function create_step_button (step, index) {
      ...
      async function on_step_click () {
        ...
        _.up && _.up.send('step_clicked', { ...step, index, total_steps: steps.length, is_accessible: accessible }, {})
      }
      ...
      if (auto_focus_first && index === 0) {
        btn.classList.add('active')
        center_step(btn)
        _.up && _.up.send('step_clicked', { ...step, index: 0, total_steps: steps.length, is_accessible: accessible }, {})
      }
    }
  }
