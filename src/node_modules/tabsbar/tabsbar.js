...
async function tabsbar (opts, invite) {
  ...
  function handle_forward_tabs (msg) {
    console.error('tabsbar: forwarding to tabs', msg.type)
    _.tabs(msg.type, msg.data, msg.head ? { cause: msg.head } : {})
  }
  ...
  function tabs_protocol (msg) {
    console.error('tabsbar: tabs_protocol', msg.type, msg.data)
