...
async function program_container (opts, protocol) {
  ...
  function actions_protocol (send) {
    ...
    function actions_forward_up (msg) { _.up(msg) }
  }
  ...
  function onmessage (msg) {
    ...
    const handler = action_handlers[msg.type] || onmessage_noop
    handler(msg)
    ...
    function onmessage_filter_actions (msg) { _.send_actions(msg) }
    function onmessage_tab_close_clicked (msg) { _.send_tabbed_editor({ ...msg, type: 'close_tab' }) }
    function onmessage_entry_toggled (msg) { _.send_graph_explorer(msg) }
    ...
    function onmessage_send_actions (msg) { _.send_actions(msg) }
    function onmessage_noop () {fail()}
