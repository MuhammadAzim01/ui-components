...
async function action_bar (opts, protocol) {
  ...
  function quick_actions_activate_steps_wizard (msg) { _.up({ type: 'activate_steps_wizard', data: msg.data, head: msg.head ? [by, to, mid++] : undefined, refs: msg.head ? { cause: msg.head } : {} }) }
