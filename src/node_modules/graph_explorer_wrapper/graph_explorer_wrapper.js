...
async function graph_explorer_wrapper (opts, invite) {
  ...
  function send_to_graph_explorer_message (type, refs, data) {
    ...
    _.graph_explorer(type, refs, data)
  }
  ...
  function flush_to_graph_explorer_queue () {
    while (can_send_to_graph_explorer() && pending_to_graph_explorer.length) {
      ...
      _.graph_explorer(next_msg.type, next_msg.refs, next_msg.data)
    }
  }
  ...
  function handle_db_request ({ head, type, data }) {
    ...
    function db_fail () {
      const msg = db ? '[graph_explorer_wrapper] Unknown db operation:' : '[graph_explorer_wrapper] Database not initialized yet'
